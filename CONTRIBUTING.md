...
1. Make an [Issue](https://github.com/common-games/Utilities.Shared/issues/new)
...
```json
    {
        "dependencies": {
            "com.common-games.Utilities.Shared": "https://github.com/YOUR_USER/Utilities.Shared.git"
        }
    }
```
...
reported to the community leaders responsible for enforcement at walter@common-games.com.
